      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="pl-6 border-l-2 border-purple-500/50 relative">
                ...
                <span className="text-xs font-bold text-purple-300 bg-purple-500/10 px-2 py-1 rounded inline-block">
                  {edu.year}
                </span>
              </div>
            ))}
        ...
        >
          <div className="bg-white/5 backdrop-blur-sm rounded-[2.5rem] p-8 border border-white/10">
            <h3 className="text-2xl font-black text-white mb-8">Technical Expertise</h3>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["React", "Next.js", "Tailwind CSS", "Framer Motion", "JavaScript", "HTML5"].map((s) => (
                    <span
                      key={s}
                      className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-sm font-semibold text-slate-300"
                    >
                      {s}
                    </span>
                  ))}
